			...
			<div class="card">
				<div class="card-header card-header-primary">
					...
					<div class="pull-right">
						...
						<a href="{URLRELATORIO}" title="Adicionar">
							<button type="button" class="btn btn-primary"><i class="material-icons">shop_two</i> Histórico
							</button>
						</a>
					</div>
					<span style="float: right;">Saldo:R$ {SALDO}</span>
				</div>
				<div class="card-body">
					<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td>{NOME}</td>
							<td>
								<a href="{URLFECHARCAIXA}" title="Fechamento" rel="tooltip" class="btn btn-danger btn-link btn-sm">
